...
\begin{slide}{Princípios da Destilação por Membranas}
  ...
  \begin{columns}
    ...
    \end{column}
  \end{columns}
  \vfill\hfill{\scriptsize Figura: Domínio de modelagem do transporte de massa em AGMD/V-AGMD — interface de evaporação, poros, espaço de ar e condensação. Fonte: Autor: Zheng (2017)}
