...
\begin{slide}{Princípios da Destilação por Membranas}
  ...
  \begin{columns}
    \begin{column}{.58\linewidth}
      \begin{Item}
        \item Processo de separação térmico com membrana \textbf{hidrofóbica} e \textbf{microporosa}
        \item Força motriz: \textbf{gradiente térmico} $\rightarrow$ diferença de pressão parcial de vapor
        \item Apenas a fase vapor atravessa os poros da membrana (não há filtração — a membrana não é molhada)
