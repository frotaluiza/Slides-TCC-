...
\begin{slide}{Fundamentos de Aprendizado de Máquinas}
  ...
  \begin{tabular}{p{0.17\linewidth} p{0.38\linewidth} p{0.38\linewidth}}
      ...
      \midrule
      \textbf{Seleção (1-SE)}
      & Critério \textit{one-standard-error}: escolhe-se o modelo mais simples com erro dentro de $\pm 1$ erro padrão do melhor \cite{Hastie2009ESL}
      & Reduzir sobreajuste no processo de seleção de hiperparâmetros \\
      \midrule
