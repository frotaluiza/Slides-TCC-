...
\begin{slide}{Hibridização e Generalização}
  ...
  \begin{columns}
    ...
    \item Adicionalmente, o PhyResidual (Flux) apresentou CV RMSE (0,072) comparável ao desempenho de regressões lineares (Lasso\_Indep, 0,082), indicando que o modelo híbrido manteve estabilidade preditiva mesmo com uma arquitetura mais complexa.
    \end{Item}
    \end{column}
  \end{columns}
