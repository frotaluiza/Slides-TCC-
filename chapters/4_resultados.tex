...
\begin{slide}{Stage 2 — Modelos Híbridos}
  ...
  \begin{tabular}{llcccccc}
    ...
    \bottomrule
  \end{tabular}
  \note{PhyResidual (base Flux) venceu para todos os alvos pelo menor Test RMSE. Para T\_ref, diferença sobre Ridge é marginal (2,3\%); Ridge tem melhor CV (extrapolação). [~2 min]}
\end{slide}
%========================================================================
...
\begin{slide}{Comparação Final — Consolidado por Variável de Saída}
  ...
  \footnotesize
    ...
    \textbf{T$_{alim,out}$} & Stage 1 & Baseline Alim & 0,215 & 0,260 & 0,981 \\
    \textbf{T$_{alim,out}$} & Stage 2 & PhyResidual (Flux) & \textbf{0,183} & 0,275 & \textbf{0,981} \\
    \midrule
...
\begin{slide}{Predição vs Experimental — Modelos Selecionados}
  ...
  \vfill
    {\scriptsize \textcolor{blue!70!black}{T$_{alim,out}$}: PhyResidual$^{Flux}$ (Stage 2) \;|\;
  ...
  \note{O overlay atualizado mostra os modelos selecionados para cada target: PhyResidual (base Flux) para os tr\^{e}s. Os quadrados cinza representam o modelo 0D como referência. [~1 min]}
\end{slide}
%========================================================================
