...
\begin{slide}{Comparação Final — Consolidado por Variável de Saída}
  ...
  \footnotesize
    ...
    \bottomrule
  \end{tabular}
  \note{Test RMSE em negrito = menor erro por variável; CV RMSE em negrito = melhor generalização. Para T$_{alim}$ e T$_{ref}$, o melhor Test é do híbrido mas o melhor CV é do linear — evidenciando o trade-off entre precisão em teste e extrapolação. [~2 min]}
\end{slide}
%========================================================================
