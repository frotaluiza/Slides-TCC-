...
\begin{slide}{Stage 2 — Modelos Híbridos}
  ...
  \begin{tabular}{llcccccc}
    ...
    \bottomrule
  \end{tabular}
  \note{PhyResidual performou melhor para todos os alvos: base Flux para T\_alim e Flux, base Alim para T\_ref. Flux Test 0,054. [~2 min]}
\end{slide}
%========================================================================
...
\begin{slide}{Comparação Final — Consolidado por Variável de Saída}
  ...
  \footnotesize
    ...
    \textbf{T$_{alim,out}$} & Stage 2 & PhyResidual (Flux) & 0,183 & 0,275 & \textbf{0,981} \\
    \midrule
    ...
    \textbf{T$_{ref,out}$} & Stage 2 & PhyResidual (Alim) & 0,222 & 0,301 & 0,995 \\
    \midrule
...
\begin{slide}{Análise por Variável de Saída}
  ...
  \begin{columns}
    ...
    \begin{Item}[0.15]
    \item[\textcolor{blue!70!black}{T$_{alim,out}$}:] Entre as híbridas, a melhor foi a PhyResidual (base Flux) com Test RMSE 0,183 — superando inclusive a Baseline Alim (Stage 1, 0,215). O modelo 0D tem R² negativo (-0,404), sugerindo que o viés sistemático foi mais bem corrigido pela arquitetura residual treinada na baseline Flux.
