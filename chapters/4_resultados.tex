...
\begin{slide}{Análise por Variável de Saída}
  ...
  \begin{columns}
    ...
    \begin{Item}[0.15]
    \item[\textcolor{blue!70!black}{T$_{alim,out}$}:] Pelo menor Test RMSE, PhyResidual (base Flux) venceu (0,183) — 14,9\% melhor que Baseline Alim (0,215).
    \item[\textcolor{orange!70!black}{T$_{ref,out}$}:] Pelo menor Test RMSE, PhyResidual (base Flux) venceu (0,214) — diferença marginal de 2,3\% sobre Ridge (0,219). Ridge tem CV RMSE 0,195 vs 0,346, indicando melhor extrapolação. Redes lineares são mais robustas para regimes não vistos.
