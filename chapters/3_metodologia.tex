...
\begin{slide}{Busca de Hiperparâmetros}
  ...
  \begin{Item}
    ...
    \item \textbf{Variáveis ajustadas por arquitetura}: lineares ($\alpha$), árvores (profundidade, nº estimadores, learning rate), redes neurais (camadas, neurônios, LR, L2, ativação), híbridos (apenas L2)
  ...
  \end{Item}
  \note{Busca por arquitetura e por target. Variaveis: lineares (alpha), arvores (profundidade, estimadores, lr), redes (camadas, neuronios, lr, l2, ativacao), hibridos (so L2). Redes usaram Random Search; demais usaram GridSearchCV. [~1,5 min]}
\end{slide}
%========================================================================
