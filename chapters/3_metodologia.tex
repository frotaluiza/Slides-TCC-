...
\begin{slide}{Busca de Hiperparâmetros}
  ...
  \end{tabular}
  \vfill
  {\footnotesize Para cada família e cada \textbf{target}, uma busca independente foi realizada via \textbf{GridSearchCV} (busca exaustiva sobre a grade) com GroupKFold (3 folds). Os híbridos tiveram busca restrita (apenas L2) para isolar o efeito da incorporação da física.}
