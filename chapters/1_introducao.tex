  ...
  \begin{columns}[T]
    \begin{column}{.55\linewidth}
      \begin{Item}
        ...
        \item Dessalinização: custo de R\$ 2,63--4,21/m³, competitivo com tarifas industriais (estudo \textcolor{poliRed}{CNI}, 2024)
...
\begin{slide}{Motivação e Objetivos}
  \footnotesize
  \begin{myTitledBox}[Motivação e Objetivos]
    \textbf{Motivação:} prever o desempenho do módulo V-AGMD (fluxo de permeado e temperaturas de saída) a partir de dados experimentais (174 pontos, 3 regimes de salinidade). Um modelo físico 0D já publicado pelo laboratório (LISBOA et al., 2024) serve como referência para o sistema.
    \vspace{0.15cm}

    \textbf{Objetivo geral:} avaliar e selecionar modelos de regressão supervisionada para predição do desempenho do V-AGMD, combinando aprendizado a partir de dados com informação física proveniente do modelo reduzido 0D.
  \end{myTitledBox}
