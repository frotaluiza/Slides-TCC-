...
\begin{slide}{Motivação e Objetivos}
  ...
  \begin{myTitledBox}[Motivação]
    Necessidade de prever desempenho do V-AGMD com dados experimentais (174 pontos, 3 regimes de salinidade). Modelo físico 0D disponível como referência para modelagem híbrida.
  \end{myTitledBox}
  \vspace{0.1cm}
