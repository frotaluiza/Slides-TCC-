...
\begin{slide}{Objetivos}
  ...
  \end{myTitledBox}
  \note{Objetivo geral: avaliar e selecionar modelos de regressão para predição do desempenho do V-AGMD, combinando dados experimentais (174 pontos, 3 regimes) com o modelo físico de referência \cite{Lisboa2024}. [~1 min]}
\end{slide}
%========================================================================
