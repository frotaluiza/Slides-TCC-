  ...
  \begin{columns}[T]
    \begin{column}{.55\linewidth}
      \begin{Item}
        ...
        \item Dessalinização: em ambientes de escassez, viabiliza desenvolvimento econômico e melhora a qualidade de vida via oferta de água de boa qualidade (estudo \textcolor{poliRed}{CNI}, 2026)
        \item Maior planta do Brasil (ES): atende demanda de 80 mil pessoas (\textcolor{poliRed}{CNI}, 2026)
...
\begin{slide}{Objetivos}
  ...
  \begin{myTitledBox}[Objetivos]
    \textbf{Objetivo geral:} avaliar e selecionar modelos de regressão para predição do desempenho do módulo V-AGMD (fluxo de permeado e temperaturas de saída), combinando aprendizado a partir de dados experimentais (174 pontos, 3 regimes de salinidade) com informação física proveniente de um modelo físico de referência~\cite{Lisboa2024}.
  \end{myTitledBox}
  \vfill
  \begin{Item}[0.10]
    \item \textbf{Por que o modelo 0D?} Foi o modelo de referência disponível com maior familiaridade no laboratório a partir de artigos e trabalhos anteriores~\cite{Lisboa2024}, além de oferecer a melhor relação custo computacional / fidelidade fenomenológica para servir como referência em arquiteturas híbridas.
  \end{Item}
  \note{Objetivo geral: avaliar e selecionar modelos de regressão para predição do desempenho do V-AGMD, combinando dados experimentais (174 pontos, 3 regimes) com o modelo físico 0D do laboratório \cite{Lisboa2024} como referência. Justificativa do 0D: familiaridade e custo computacional favorável. [~1 min]}
\end{slide}
%========================================================================
