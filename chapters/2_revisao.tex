...
\begin{slide}{Lacunas e Contribuições}
  ...
  \end{columns}
  \vfill
  \note{Lacunas: 1) validação por partição única, sem CV por grupos — métricas otimistas para extrapolação, risco de sobreajuste. 2) seleção por RMSE puro ignora variabilidade — 1-SE (navalha de Occam, \cite{Hastie2009ESL}) é estratégia estabelecida que escolhe o modelo mais simples dentro de 1 erro padrão do melhor. 3) híbridos em MD praticamente inexistentes. Contribuições: validação cruzada, 1-SE, arquiteturas híbridas pré-existentes \cite{Rai2020} aplicadas ao V-AGMD. [~2 min]}
\end{slide}
%========================================================================
